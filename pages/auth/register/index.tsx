    ...
    <div className="max-w-md w-full p-6">
      ...
      <form action="#" method="POST" className="space-y-4">
        <div>
          ...
          <input type="text" placeholder='ex : yvanDev237' id="username" name="username" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
        </div>
        <div>
          <label htmlFor="headline" className="block text-sm font-medium text-gray-700">Headline</label>
          <input type="text" id="headline" placeholder='ex : Fullstack Developer'  name="headline" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
        </div>
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-gray-700">Email</label>
          <input type="text" id="email" placeholder='ex : yvandev237@gmail.com ' name="email" className="mt-1 p-2 w-full border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300" />
        </div>
        <div>
        ...
        <div>
          <label htmlFor="password" className="block text-sm mb-2 font-medium text-gray-700">Your Profile Image</label>
          <input type="file" className="file-input w-full  file-input-sm " />

        </div>
        <div className='mt-6'>
          <button type="submit" className="btn w-full bg-indigo-500 text-white hover:bg-indigo-800">Sign Up</button>
        </div>
      </form>
      <div className="mt-4 text-sm text-gray-600 text-center">
