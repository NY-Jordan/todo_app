...
const ProjectsTable = () => {
  ...
  return (
    <>
         <div className="rounded-sm shadow-lg border dark:bg-slate-800 dark:border-slate-800 dark:text-white  border-stroke bg-white px-5 pb-2.5 pt-6  overflow-y-auto dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
