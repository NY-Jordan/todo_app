...
export default function NotificationInvitationAccepted({notification} : { notification: NotificationInvitationInterface}) {
       ...
       <>
          ...
          <div className='flex flex-col items-center justify-center'>
            ...
            <strong> {notification.content.receiver.name}  </strong>
             have accepted to join  <strong>{notification.content.project.name} </strong> project
            </p>
          </div>
      </div>
